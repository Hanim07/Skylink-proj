...
<!-- Hero Section -->
<section class="bg-dark text-white py-5" style="background: url('{{ asset('assets/images/service-banner.jpg') }}') center center/cover no-repeat;">
        ...
        @forelse ($items as $item)
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card h-100 shadow-lg border-0 transition hover-shadow">
                    <img src="{{ asset('assets/images/services/' . $item['image']) }}"
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="{{ route('services.detail', ['subcategory' => $item['slug']]) }}"
